/*
 * File     : OPTXEngineApplication.java
 *
...
public class OPTXEngineApplication extends MessageCracker 
    ...
    public OPTXEngineApplication( SessionSettings settings, 
    ...
    public void onLogon( SessionID sessionID ) {
        ...
        if (connectedStatus != null)
            ...
            .getResource("/edu/harvard/fas/zfeledy/optxengine/ui/green.gif")));
    }
    ...
    public void onLogout( SessionID sessionID ) {
    	...
    	currentSession = null;
        connectedStatus.setIcon(new javax.swing.ImageIcon(getClass()
            .getResource("/edu/harvard/fas/zfeledy/optxengine/ui/red.gif")));
    }
    ...
    public void onMessage( quickfix.fix42.NewOrderSingle message, 
        ...
        if ( executorStarted ) {
            ...
            try {
                autoAck = settings.getBool("OPTXEngineAutoAcknowledge");
            } catch ( Exception e ) {}
            if ( autoAck ) {
                acknowledge( order );
            }
    ...
    public void onMessage( quickfix.fix42.OrderCancelRequest message, 
        ...
        try {
            autoPending = settings.getBool("OPTXEngineAutoPendingCancel");
            autoCancel = settings.getBool("OPTXEngineAutoCancel");
        } catch ( Exception e ) {}
        if ( autoPending ) {
            pendingCancel(order);
        }
    ...
    public void onMessage( quickfix.fix42.OrderCancelReplaceRequest message, 
        ...
        boolean autoCancel = false;
        try {
            autoPending = settings.getBool("OPTXEngineAutoPendingReplace");
            autoCancel = settings.getBool("OPTXEngineAutoReplace");
        } catch ( Exception e ) {}
        if ( autoPending ) {
    ...
    public void sendMessage( Message message ) {
        ...
        try {
            ...
            sendoboCompID = settings.getBool("OPTXEngineSendOnBehalfOfCompID");
            sendoboSubID = settings.getBool("OPTXEngineSendOnBehalfOfSubID");
        } catch ( Exception e ) {}
    ...
    public void sendIOI( IOI ioi ) {
        ...
        Instrument instrument = 
                OPTXEngine.getInstruments().getInstrument(ioi.getSymbol());
    ...
    public class IOIsender implements Runnable {
    	...
    	public IOIsender ( Integer delay, String symbol, String securityID ) {
            instruments = OPTXEngine.getInstruments();
    	...
    	public void sendRandomIOI() {
            ...
            try {
                pricePrecision = 
                        (int)settings.getLong("OPTXEnginePricePrecision");
            } catch ( Exception e ) {}
